    ...
    iSlider && iSlider.extend(iSlider._animateFuncs, {
        ...
        flow: (function () {
            function flow(dom, axis, scale, i, offset, direct) {
                ...
                iSlider.setStyle(outer, 'perspective', scale * 1.5);
                ...
                iSlider.setStyle(dom, 'transform', 'scale(0.4, 0.4) translateZ(' + (offsetRatio * 150 - 150) * Math.abs(i - 1) + 'px)' + 'translate' + axis + '(' + (offset + scale * (i - 1)) + 'px)' + 'rotate' + rotateDirect + '(' + directAmend * (15 - offsetRatio * 15) * (1 - i) + 'deg)');
            }
