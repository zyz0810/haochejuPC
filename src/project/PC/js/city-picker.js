    ...
    CityPicker.prototype = {
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                textspan = '<span class="city-picker-span" style="width:300px;' +
                    'height:' + p.height + 'px;line-height:' + (p.height - 1) + 'px;">' +
                    (placeholder ? '<span class="placeholder">' + placeholder + '</span>' : '') +
                    '<span class="title"></span><div class=""></div>' + '</span>',

                dropdown = '<div class="city-picker-dropdown" style="left:0px;top:150%;width:320px;'+
                    '">' +
